...
class ll_ATS(unittest.TestCase):
    ...
    def test_ll(self):
        ...
        # Click add genre
        driver.find_element_by_xpath(
            "/html/body/div/div[3]/nav/div[2]/table/tbody/tr[4]/td/a").click()
        time.sleep(3)
        driver.find_element_by_xpath("/html/body/div/div[3]/div/div[1]/div/form/div/fieldset/div/div/input").send_keys("James")
        time.sleep(3)
        driver.find_element_by_xpath(
